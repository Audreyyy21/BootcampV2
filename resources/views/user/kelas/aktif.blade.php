...
<div class="p-6 w-full h-full bg-white rounded-xl shadow">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('user.kelas.histori') }}" class="text-yellow-600 hover:underline">Lihat Riwayat</a>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($jadwalAktif as $j)
            <div class="border rounded-xl shadow-sm hover:shadow-md transition bg-gray-50 overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <span class="inline-block mt-3 bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium">
                        {{ ucfirst($j->status) }}
                    </span>
                </div>
            </div>
